            ...
            <div className="lg:w-1/4">
              <div className="bg-white p-6 shadow-sm">
                <div className="flex items-center mb-6">
                  ...
                  <div>
                    <h2 className="font-medium">Budi Santoso</h2>
                    <p className="text-sm text-gray-500">budi.santoso@example.com</p>
                  </div>
                </div>
                ...
                <nav>
                  <ul className="space-y-2">
                    ...
                    <li>
                      <Link
                        to="/profile/orders"
                        className="flex items-center py-2 px-3 bg-gray-100 font-medium rounded"
                      >
                  ...
                  <div className="flex flex-col md:flex-row gap-4 w-full md:w-auto">
                    <div className="relative">
                      <input
                        ...
                        className="w-full md:w-64 border border-gray-300 px-4 py-2 pr-10 focus:outline-none"
                      />
                      <Search className="absolute right-3 top-2.5 h-4 w-4 text-gray-400" />
                    </div>

                    <select className="border border-gray-300 px-4 py-2 focus:outline-none">
